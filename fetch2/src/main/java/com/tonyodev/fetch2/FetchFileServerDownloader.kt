...
open class FetchFileServerDownloader @JvmOverloads constructor(
    ...
    protected val connections: MutableMap<Downloader.Response, FetchFileResourceTransporter> =
        Collections.synchronizedMap(HashMap<Downloader.Response, FetchFileResourceTransporter>())

    override fun onPreClientExecute(
        client: FetchFileResourceTransporter,
        request: Downloader.ServerRequest
    ): FileServerDownloader.TransporterRequest {
