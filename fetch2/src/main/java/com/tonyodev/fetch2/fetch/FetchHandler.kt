...
interface FetchHandler : Closeable {
    ...
    fun updateCompletedDownloadFile(id: Int, newFileName: String, tag: String): Download
    fun insertDownloadInfo(id: Int, url: String, fileName: String, tag: String): Download
