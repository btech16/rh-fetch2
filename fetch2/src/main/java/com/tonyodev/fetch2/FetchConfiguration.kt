...
class FetchConfiguration private constructor(
    ...
    * */
    ...
    class Builder(context: Context) {
        ...
        private var progressReportingIntervalMillis =
        ...
        private var storageResolver: StorageResolver =
            DefaultStorageResolver(appContext, getFileTempDir(appContext))
        ...
        private var activeDownloadCheckInterval =
            DEFAULT_HAS_ACTIVE_DOWNLOADS_INTERVAL_IN_MILLISECONDS
