...
const val FAILED_TO_ENQUEUE_REQUEST_FILE_FOUND =
    "UNIQUE constraint failed: requests._file (code 2067)"
...
const val FAILED_RENAME_FILE_ASSOCIATED_WITH_INCOMPLETE_DOWNLOAD =
    "cannot rename file associated with incomplete download"
