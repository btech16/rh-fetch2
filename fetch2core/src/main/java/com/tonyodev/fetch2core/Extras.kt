...
open class Extras(
    ...
    protected val data: Map<String, String>
    ...
    companion object CREATOR : Parcelable.Creator<Extras> {
        ...
        override fun createFromParcel(source: Parcel): Extras {
            ...
            // FIXME:  You Can Use This Code With Some Modified
//            val data = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
//                source.readSerializable(ClassLoader.getSystemClassLoader() , HashMap<String , String>::class.java)
//            } else {
